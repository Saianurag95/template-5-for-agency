...
export const services = [
  ...
  },
  {
    ...
    title: "Landing Pages",
    description:
      "High-conversion single pages for campaigns, product launches, and lead generation — built to perform.",
    icon: "Layout",
  },
  {
    id: 3,
  ...
  },
  {
    ...
    description:
      "Post-launch updates, performance monitoring and content management support — so your site stays sharp.",
    icon: "Wrench",
  },
];
...
export const stats = [
  ...
  { value: "1–3 Days", label: "Turnaround Time" },
